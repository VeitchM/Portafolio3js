...
export default function Home() {
  ...
  const [subtitle, setSubtitle] = useState(subtitleDict[language]);
  const [subtitle2, setSubtitle2] = useState(subtitle2Dict[language]);

  const [isOpen, setIsOpen] = useState("open");

  useEffect(() => {
    transitionOnSet(() => {
      setSubtitle(subtitleDict[language]);
  ...
  return (
    ...
    <>
      <section 
      // className="w-full h-full p-4 lg:p-24 pt-4 lg:pt-24"
      className="w-screen h-screen p-4 lg:p-24 pt-4 lg:pt-24"
