...
sections[0].es = Section.sectContent(
    'Acerca de mi',
    [
        ['Formacion', 'Soy un estudiante avanzado de la carrera de Ingenieria Informatica de la Universidad Nacional de Mar del Plata.',
        ...
        ['Perfil',
            ...
            , Section.link('Descargar CV', 'https://docs.google.com/document/d/1t58WQXp5FvzyUJOjjgcz6NojBMHfB8Cj/export?format=pdf')]])

sections[0].en = Section.sectContent(
    "About me",
    [
        ["Education", "I am an advanced student of the Software Engineering degree at the National University of Mar del Plata.",
        ...
        ["Profile",
            ...
            Section.link("Download CV", "https://docs.google.com/document/d/1jyjaNjgsLRNhbr0lNQJhJ0GG1gTLsqIX/export?format=pdf")]])

sections[1].es = Section.sectContent(
    "Conocimientos",
    [
        ["Herramientas",
            "JavaScript, Java, C, React, PostgreSQL, Docker, Git, Debian", "Tengo conocimientos y practica del uso de Node.js, Java, Git, Docker, PostgreSQL adquiridos mediante la Universidad", "Estoy familiarizado con sistemas GNU Linux, principalmente Debian cual utilizo cotidianamente",
...
sections[1].en = Section.sectContent(
    "Skills",
    [
        ["Tools and Technology",
            "JavaScript, Java, C, React, PostgreSQL, Docker, Git, Debian", "I have knowledge and experience using Node.js, Java, Git, Docker, PostgreSQL acquired through the University", "I am familiar with GNU Linux systems, mainly Debian which I use daily",
...
sections[2].es = Section.sectContent(
    'Intereses',
    [
    ['Aprendizaje de Machine Learning',
        ...
        Section.link('Certificado de FreeCodeCamp', "https://www.freecodecamp.org/certification/fcc630df60e-4a43-4c1a-b035-69b001883eb1/machine-learning-with-python-v7")
    ],
...
sections[2].en = Section.sectContent(
    'Interests',
    [
        ['Machine Learning',
            ...
            Section.link('FreeCodeCamp Certificate', "https://www.freecodecamp.org/certification/fcc630df60e-4a43-4c1a-b035-69b001883eb1/machine-learning-with-python-v7")
        ],
